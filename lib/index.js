...
var route = 'C:/Users/Programaciòn/Desktop/LIM009-fe-md-links/example'; //  let route= '/Users/Soul/Desktop/LIM009-fe-md-links';
...
var extractedLink = function extractedLink(route) {
  ...
  arrayOfFile.forEach(function (filePath) {
    var mdContent = readFile(filePath);
    var renderer = new mymarked.Renderer(mdContent);
...
var validateLink = function validateLink(route) {
  var arrayLinks = extractedLink(route).map(function (link) {
